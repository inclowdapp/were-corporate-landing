            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-border bg-card p-5">
                ...
                <ol className="mt-2 space-y-1.5 text-sm text-foreground/85">
                  {T.about.missionText[lang].map((item, i) => (
...
// ---------- Testimonials ----------
const TESTIMONIALS = [
  { name: "Sari L.", city: "Yogyakarta", quote: { id: "Asmaraloka benar-benar membantu menjaga stamina saya sebagai ibu bekerja.", en: "Meguaz truly helps maintain my stamina as a working mom." } },
  ...
  { name: "Rina W.", city: "Surabaya", quote: { id: "Meguaz membantu saya merasa lebih seimbang setiap hari.", en: "Asmaraloka helps me feel more balanced every day." } },
];
